-- ============================================================
-- Canteen Management System - Supabase / PostgreSQL Seed Data
-- ============================================================
...
-- Default Users (Passwords: admin123, staff123, customer123)
INSERT INTO users (id, name, email, phone, password, enabled) VALUES
...
-- Menu Items
INSERT INTO menu_items (id, name, description, price, category_id, available, vegetarian, rating, rating_count, preparation_time) VALUES
...
-- Inventory
INSERT INTO inventory (menu_item_id, quantity, unit, min_stock_level) VALUES
(1,  100, 'plates',  20),
(2,  150, 'plates',  30),
(3,  120, 'pieces',  25),
(4,  80,  'plates',  15),
...
-- Coupons
INSERT INTO coupons (code, description, discount_percent, max_discount, min_order_amount, expiry_date, usage_limit, active) VALUES
